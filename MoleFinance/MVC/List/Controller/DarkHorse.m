...
#import "DarkHorse.h"
#import "InvestData.h"
#import "DarkHorseCell.h"
#import "baseController.h"
static NSString *cellid=@"dark";
@interface DarkHorse (){
...
-(void)getData{
    ...
    NSString *url=[NSString stringWithFormat:API_DARK,_page];
    print(url)
    [inv getData:url];
}
...
-(void)setupTableView{
    ...
    tab.delegate=self;
    tab.dataSource=self;
    [tab registerNib:[UINib nibWithNibName:@"DarkHorseCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:cellid];
    //上下拉刷新
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DarkHorseCell *cell=[tableView dequeueReusableCellWithIdentifier:cellid];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    NSLog(@"我可以点击");
    NSDictionary *dic=collection[indexPath.row];
    NSString *UrlString=[NSString stringWithFormat:API_DARK_CLICK,dic[@"newsid"],dic[@"newstype"]];
    print(UrlString)
